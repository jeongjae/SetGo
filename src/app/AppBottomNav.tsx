...
export function AppBottomNav({ activeView, onNavigate }: AppBottomNavProps) {
  ...
  return (
    <nav aria-label="Primary navigation" className="app-bottom-nav mx-auto grid w-full max-w-md shrink-0 grid-cols-4 border-t border-slate-650 bg-white/95 px-2 pt-2 text-slate-100 shadow-[0_-8px_24px_rgba(11,31,51,0.04)] backdrop-blur-md">
