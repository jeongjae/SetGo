...
const en = {
  ...
  actualsCalendar: 'Records calendar',
  ...
  history: 'History',
  records: 'Records',
  recordsAnalysis: 'Analysis',
  recordsCalendar: 'Calendar',
  ...
  todayRecommendationMakeUp: 'A recently skipped routine is ready to make up.',
...
const ko: typeof en = {
  ...
  todayRecommendationMakeUp: '최근 건너뛴 루틴을 먼저 수행하도록 추천합니다.',
